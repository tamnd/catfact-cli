...
Most of these come down to network reality or how catfact serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

catfact rate-limits like any public site. catfact already paces
...
Where a surface is gated, catfact reads a cookie or token you supply
...
`catfact`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what catfact actually did
